...
function MainQuestion() {
  ...
  return (
    ...
    <div className='question-answer'>
        ...
        <div className="comment"><p>This is comment - <span>User name</span><small> Timestamp</small></p>
        </div>
        <p onClick={()=>setshow(!show)}>Add a comment</p>
        {
            show && (<div className="title">
                ...
                <button style={{maxWidth: "fit-content",marginTop:"15px"}}>Add comment</button>
            </div>)
        }
        </div>
    </div>
